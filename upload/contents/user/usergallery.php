...
# bilder abfragen
	...
	$slide = db_query("SELECT * FROM prefix_usergallery WHERE uid = $uid");
	while($rowslide = db_fetch_assoc($slide)){
		$bxslider .= "<li><center><img src=\"/include/images/usergallery/img_".$rowslide['id'].".".$rowslide['endung']."\" /></center></li>";
	}
